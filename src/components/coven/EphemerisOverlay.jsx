...
function Row({ label, value, sub }) {
  return (
    <div className="flex items-baseline justify-between gap-3 px-4 py-3 border-b border-[#A89968]/15">
      <span className="text-[#9E2A33]/70 text-[10px] uppercase tracking-[0.3em]" style={F.scriptureSC}>{label}</span>
      <div className="text-right">
        <div className="text-[#F5F1E8] text-base" style={F.scripture}>{value}</div>
        {sub && <div className="text-[#9E2A33]/50 text-[10px]" style={F.mono}>{sub}</div>}
      </div>
    </div>
  );
}
    ...
    <div className="animate-portal-in absolute inset-0 z-30 overflow-y-auto safe-pb"
      ...
      <div className="relative px-4 pt-6 pb-12">
        <div className="text-center mb-2">
          <div className="text-[#9E2A33]/60 text-[10px] uppercase tracking-[0.4em]" style={F.scriptureSC}>· tonight's sky ·</div>
        ...
        <div className="text-center mb-6">
          ...
          <div className="text-[#9E2A33]/60 text-[10px] uppercase tracking-[0.3em] mt-1" style={F.scriptureSC}>
        ...
        <p className="mt-10 text-center text-[#9E2A33]/40 text-[10px] italic max-w-xs mx-auto" style={F.scripture}>
          · as above, so below ·
        </p>
      </div>
    </div>
