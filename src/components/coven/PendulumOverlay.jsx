    ...
    <div className="animate-portal-in absolute inset-0 z-30 overflow-y-auto safe-pb"
      ...
      <div className="relative px-6 pt-8 pb-12">
        <div className="text-center mb-6">
          <div className="text-[#9E2A33]/60 text-[10px] uppercase tracking-[0.4em]" style={F.scriptureSC}>· consult the line ·</div>
        ...
        <div className="max-w-sm mx-auto">
          {!answer && (
            <>
              ...
              <button onClick={ask} disabled={!question.trim() || swinging}
                className="mt-3 w-full py-3 border border-[#A89968]/40 text-[#9E2A33] hover:border-[#C9A961] hover:text-[#C9A961] disabled:opacity-40 disabled:hover:border-[#A89968]/40 disabled:hover:text-[#9E2A33] text-xs uppercase tracking-[0.3em] transition-colors"
                style={F.ui}>
          ...
          {answer && (
            <div className="text-center">
              <p className="text-[#9E2A33]/60 text-xs italic mb-3" style={F.scripture}>"{question}"</p>
              ...
              <p className="text-[#9E2A33]/60 text-xs italic" style={F.scripture}>· {answer.detail} ·</p>
