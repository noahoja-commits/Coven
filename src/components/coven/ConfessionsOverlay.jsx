...
export function ConfessionsOverlay({ onClose, userConfessions = [], onConfess, onReact, onReport }) {
  ...
  return (
    <div className="animate-portal-in absolute inset-0 z-30 overflow-y-auto safe-pb"
      ...
      <div className="sticky top-0 z-10 bg-[#050204]/95 backdrop-blur-md border-b border-[#5E3B73]/20 safe-pt">
      ...
      <div className="relative px-4 pt-6 pb-12">
        <div className="text-center mb-4">
          <div className="text-[#9E2A33]/60 text-[10px] uppercase tracking-[0.4em]" style={F.scriptureSC}>· anonymous · ephemeral ·</div>
        ...
        <OrnamentRule glyph="𖤐" color="#5E3B73" tint="#A89968" className="mb-5 max-w-md mx-auto" />
        ...
        <div className="space-y-3 max-w-md mx-auto">
          {userConfessions.length === 0 ? (
            ...
            <div key={c.id} className="relative overflow-hidden border border-[#5E3B73]/20 bg-[#0A0204]/60 p-5">
              <OrnateFrame glow />
              <Grain opacity={0.05} />
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-[10px] text-[#9E2A33]/50 flex items-center gap-2" style={F.scriptureSC}>
                  <button onClick={() => report(c.id)}
                    className="text-[#9E2A33]/40 hover:text-[#8B0000] transition-colors p-1 -m-1"
