  ...
  return (
    <button
      ...
      style={{
        ...
        filter: demon
          ? `drop-shadow(0 0 ${6 + anger * 5}px rgba(158,42,51,${Math.min(1, 0.6 + anger * 0.1)})) drop-shadow(0 1px 2px rgba(0,0,0,0.7))`
      ...
      {hungry && !purr && <span className="absolute -top-2 -right-1 text-[10px] text-[#9E2A33]/70">?</span>}
      {purr && !demon && (
