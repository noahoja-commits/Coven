...
const DOCS = {
  terms: {
    ...
    sections: [
      ...
      { h: 'Copyright & DMCA', body: ['Coven respects copyright. If you believe content on Coven infringes your copyright, send a takedown notice to noahoja@gmail.com that includes: identification of the work, the infringing link, your contact information, a good-faith statement that the use isn’t authorized, and a statement under penalty of perjury that you’re authorized to act for the owner. We remove infringing content, notify the poster (who may file a counter-notice), and terminate repeat infringers.'] },
  ...
  guidelines: {
    ...
    sections: [
      ...
      { h: 'Illegal content & safety', body: ['Sexual content involving minors is removed on discovery, reported to the National Center for Missing & Exploited Children (NCMEC) as required by U.S. law, and results in account termination. Other illegal content is removed and may be reported to authorities. Report anything illegal with the report tool or email noahoja@gmail.com.'] },
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="space-y-5">
            {active.sections.map((s, i) => (
              <div key={i}>
                <h3 className="text-[#9E2A33] text-[11px] uppercase tracking-[0.2em] mb-1.5" style={F.scriptureSC}>{s.h}</h3>
                {s.body.map((p, j) => (
