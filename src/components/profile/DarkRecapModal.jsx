  ...
  return (
    <div className="fixed inset-0 z-[60] bg-black/85 backdrop-blur-sm flex items-center justify-center p-6 animate-fade-in" onClick={onClose}>
      <div className="relative w-full max-w-xs border border-[#5B0F1A]/40 p-6 animate-slide-up overflow-hidden"
        ...
        <button onClick={onClose} className="absolute top-3 right-3 text-[#A89968]/60 hover:text-[#C9A961]" aria-label="close"><X size={18} /></button>
        <div className="text-center mb-5">
          <div className="text-[#A89968] text-[10px] uppercase tracking-[0.5em] mb-1" style={F.scriptureSC}>· your dark recap ·</div>
        ...
        <div className="space-y-3">
          ...
          {stats.topScene && (
            <div className="text-center pt-1 text-[#A89968] text-xs italic" style={F.scripture}>most at home in · {stats.topScene} ·</div>
          )}
        </div>
