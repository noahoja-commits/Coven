// `url` is set for brands with a real storefront; the rest fall back to a web
// search (see shopUrl in FashionScreen) so every tile always goes somewhere useful.
export const FASHION = [
  { id: 'f1', brand: 'Vermillion Vintage', kind: 'thrift · NYC', price: '$$', tags: ['mens', 'velvet'], h: 280, color: 'red' },
  { id: 'f2', brand: 'KILL STAR', kind: 'indie · online', price: '$$', tags: ['unisex'], h: 200, color: 'black', url: 'https://www.killstar.com' },
  { id: 'f3', brand: 'Disturbia', kind: 'indie · online', price: '$$', tags: ['mens', 'womens'], h: 240, color: 'violet', url: 'https://www.disturbia.co.uk' },
